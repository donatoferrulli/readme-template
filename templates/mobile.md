...
- Have this application's [API](https://github/donatoferrulli/readme-template) running

**Clone the project and access the folder**

```bash
$ git clone https://github.com/donatoferrulli/gobarber-mobile.git && cd gobarber-mobile
```
